...
static struct FScriptStruct_CustomAnimNode_StaticRegisterNativesFAnimNode_PR2IK
{
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_MaxIter_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/AnimNode_PR2IK.h" },
		{ "ToolTip", "UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings)\n               TArray<FIKBonesT> FeetDefinitions;\n\n       UPROPERTY(EditAnywhere, Category = Settings)\n               FBoneReference PelvisBone;\n\n       UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings)\n               EIKFootRootLocalAxis PR2IKAxisMode;\n\n       UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings, meta = (PinShownByDefault))\n               float SpeedScaling;\n\n       UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Settings)\n               float PelvisAdjustmentAlpha;" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_MaxIter = { "MaxIter", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_PR2IK, MaxIter), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_MaxIter_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_MaxIter_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_IkFootRootBone_MetaData[] = {
		{ "Category", "Settings" },
		{ "ModuleRelativePath", "Public/AnimNode_PR2IK.h" },
		{ "ToolTip", "Name of bone to control. This is the main bone chain to modify from. *" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_IkFootRootBone = { "IkFootRootBone", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_PR2IK, IkFootRootBone), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_IkFootRootBone_MetaData, ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_IkFootRootBone_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_MaxIter,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimNode_PR2IK_Statics::NewProp_IkFootRootBone,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_PR2IK_Hash() { return 3394305272U; }
